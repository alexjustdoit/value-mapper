...
def _render_calculator() -> None:
    ...
    col_name, col_save, col_dl, col_restart = st.columns([4, 2, 2, 2])
    ...
    export_text = _build_export_text(scenario_name or default_name, product.name, customer, calculator)
    col_dl.download_button(
        "⬇️  Export",
        data=export_text,
        file_name=f"{(scenario_name or default_name).replace(' ', '_')}.txt",
        mime="text/plain",
